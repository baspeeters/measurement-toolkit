[measurement-toolkit](../README.md) › ["Time/SI/Terasecond"](../modules/_time_si_terasecond_.md) › [Terasecond](_time_si_terasecond_.terasecond.md)
...
\+ **new Terasecond**(`value`: number): *[Terasecond](_time_si_terasecond_.terasecond.md)*
...
*Defined in [Time/SI/Terasecond.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Time/SI/Terasecond.ts#L14)*
...
*Defined in [Time/SI/Terasecond.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Time/SI/Terasecond.ts#L13)*
