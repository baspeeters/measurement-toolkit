[measurement-toolkit](../README.md) › ["Length/SI/Gigameter"](../modules/_length_si_gigameter_.md) › [Gigameter](_length_si_gigameter_.gigameter.md)
...
* [constructor](_length_si_gigameter_.gigameter.md#constructor)

### Properties

* [baseUnit](_length_si_gigameter_.gigameter.md#baseunit)
* [symbol](_length_si_gigameter_.gigameter.md#symbol)
* [value](_length_si_gigameter_.gigameter.md#value)

### Accessors

* [to](_length_si_gigameter_.gigameter.md#to)

### Methods

* [add](_length_si_gigameter_.gigameter.md#add)
* [divideBy](_length_si_gigameter_.gigameter.md#divideby)
* [dividedBy](_length_si_gigameter_.gigameter.md#dividedby)
* [getConverters](_length_si_gigameter_.gigameter.md#getconverters)
* [multiply](_length_si_gigameter_.gigameter.md#multiply)
* [percentageOf](_length_si_gigameter_.gigameter.md#percentageof)
* [percentageOfThis](_length_si_gigameter_.gigameter.md#percentageofthis)
* [subtract](_length_si_gigameter_.gigameter.md#subtract)
* [toString](_length_si_gigameter_.gigameter.md#tostring)

## Constructors

###  constructor

\+ **new Gigameter**(`value`: number): *[Gigameter](_length_si_gigameter_.gigameter.md)*
...
*Defined in [Length/SI/Gigameter.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/212ab3d/src/Units/Length/SI/Gigameter.ts#L13)*
...
*Defined in [Length/SI/Gigameter.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/212ab3d/src/Units/Length/SI/Gigameter.ts#L14)*
