[measurement-toolkit](../README.md) › ["Length/SI/Nanometer"](../modules/_length_si_nanometer_.md) › [Nanometer](_length_si_nanometer_.nanometer.md)
...
\+ **new Nanometer**(`value`: number): *[Nanometer](_length_si_nanometer_.nanometer.md)*
...
*Defined in [Length/SI/Nanometer.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Length/SI/Nanometer.ts#L13)*
...
*Defined in [Length/SI/Nanometer.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Length/SI/Nanometer.ts#L14)*
