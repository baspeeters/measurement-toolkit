[measurement-toolkit](../README.md) › ["Mass/SI/Zettagram"](../modules/_mass_si_zettagram_.md) › [Zettagram](_mass_si_zettagram_.zettagram.md)
...
* [constructor](_mass_si_zettagram_.zettagram.md#constructor)

### Properties

* [baseUnit](_mass_si_zettagram_.zettagram.md#baseunit)
* [symbol](_mass_si_zettagram_.zettagram.md#symbol)
* [value](_mass_si_zettagram_.zettagram.md#value)

### Accessors

* [to](_mass_si_zettagram_.zettagram.md#to)

### Methods

* [add](_mass_si_zettagram_.zettagram.md#add)
* [divideBy](_mass_si_zettagram_.zettagram.md#divideby)
* [dividedBy](_mass_si_zettagram_.zettagram.md#dividedby)
* [getConverters](_mass_si_zettagram_.zettagram.md#getconverters)
* [multiply](_mass_si_zettagram_.zettagram.md#multiply)
* [percentageOf](_mass_si_zettagram_.zettagram.md#percentageof)
* [percentageOfThis](_mass_si_zettagram_.zettagram.md#percentageofthis)
* [subtract](_mass_si_zettagram_.zettagram.md#subtract)
* [toString](_mass_si_zettagram_.zettagram.md#tostring)

## Constructors

###  constructor

\+ **new Zettagram**(`value`: number): *[Zettagram](_mass_si_zettagram_.zettagram.md)*
...
• **baseUnit**: *[Kilogram](_mass_si_kilogram_.kilogram.md)‹›* = new Kilogram(this.value * Math.pow(10, 18))
...
*Defined in [Mass/SI/Zettagram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Mass/SI/Zettagram.ts#L14)*
...
*Defined in [Mass/SI/Zettagram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Mass/SI/Zettagram.ts#L13)*
