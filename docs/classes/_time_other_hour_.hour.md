[measurement-toolkit](../README.md) › ["Time/Other/Hour"](../modules/_time_other_hour_.md) › [Hour](_time_other_hour_.hour.md)
...
* [constructor](_time_other_hour_.hour.md#constructor)

### Properties

* [baseUnit](_time_other_hour_.hour.md#baseunit)
* [symbol](_time_other_hour_.hour.md#symbol)
* [value](_time_other_hour_.hour.md#value)

### Accessors

* [to](_time_other_hour_.hour.md#to)

### Methods

* [add](_time_other_hour_.hour.md#add)
* [divideBy](_time_other_hour_.hour.md#divideby)
* [dividedBy](_time_other_hour_.hour.md#dividedby)
* [getConverters](_time_other_hour_.hour.md#getconverters)
* [multiply](_time_other_hour_.hour.md#multiply)
* [percentageOf](_time_other_hour_.hour.md#percentageof)
* [percentageOfThis](_time_other_hour_.hour.md#percentageofthis)
* [subtract](_time_other_hour_.hour.md#subtract)
* [toString](_time_other_hour_.hour.md#tostring)

## Constructors

###  constructor

\+ **new Hour**(`value`: number): *[Hour](_time_other_hour_.hour.md)*
...
• **baseUnit**: *[Second](_time_si_second_.second.md)‹›* = new Second(this.value * 3600)
...
*Defined in [Time/Other/Hour.ts:15](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Time/Other/Hour.ts#L15)*
...
*Defined in [Time/Other/Hour.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Time/Other/Hour.ts#L14)*
