[measurement-toolkit](../README.md) › ["Length/SI/Decameter"](../modules/_length_si_decameter_.md) › [Decameter](_length_si_decameter_.decameter.md)
...
* [constructor](_length_si_decameter_.decameter.md#constructor)

### Properties

* [baseUnit](_length_si_decameter_.decameter.md#baseunit)
* [symbol](_length_si_decameter_.decameter.md#symbol)
* [value](_length_si_decameter_.decameter.md#value)

### Accessors

* [to](_length_si_decameter_.decameter.md#to)

### Methods

* [add](_length_si_decameter_.decameter.md#add)
* [divideBy](_length_si_decameter_.decameter.md#divideby)
* [dividedBy](_length_si_decameter_.decameter.md#dividedby)
* [getConverters](_length_si_decameter_.decameter.md#getconverters)
* [multiply](_length_si_decameter_.decameter.md#multiply)
* [percentageOf](_length_si_decameter_.decameter.md#percentageof)
* [percentageOfThis](_length_si_decameter_.decameter.md#percentageofthis)
* [subtract](_length_si_decameter_.decameter.md#subtract)
* [toString](_length_si_decameter_.decameter.md#tostring)

## Constructors

###  constructor

\+ **new Decameter**(`value`: number): *[Decameter](_length_si_decameter_.decameter.md)*
...
*Defined in [Length/SI/Decameter.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Length/SI/Decameter.ts#L13)*
...
*Defined in [Length/SI/Decameter.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Length/SI/Decameter.ts#L14)*
