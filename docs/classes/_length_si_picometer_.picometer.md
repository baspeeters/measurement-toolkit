[measurement-toolkit](../README.md) › ["Length/SI/Picometer"](../modules/_length_si_picometer_.md) › [Picometer](_length_si_picometer_.picometer.md)
...
* [constructor](_length_si_picometer_.picometer.md#constructor)

### Properties

* [baseUnit](_length_si_picometer_.picometer.md#baseunit)
* [symbol](_length_si_picometer_.picometer.md#symbol)
* [value](_length_si_picometer_.picometer.md#value)

### Accessors

* [to](_length_si_picometer_.picometer.md#to)

### Methods

* [add](_length_si_picometer_.picometer.md#add)
* [divideBy](_length_si_picometer_.picometer.md#divideby)
* [dividedBy](_length_si_picometer_.picometer.md#dividedby)
* [getConverters](_length_si_picometer_.picometer.md#getconverters)
* [multiply](_length_si_picometer_.picometer.md#multiply)
* [percentageOf](_length_si_picometer_.picometer.md#percentageof)
* [percentageOfThis](_length_si_picometer_.picometer.md#percentageofthis)
* [subtract](_length_si_picometer_.picometer.md#subtract)
* [toString](_length_si_picometer_.picometer.md#tostring)

## Constructors

###  constructor

\+ **new Picometer**(`value`: number): *[Picometer](_length_si_picometer_.picometer.md)*
...
• **baseUnit**: *[Meter](_length_si_meter_.meter.md)‹›* = new Meter(this.value * Math.pow(10, -12))
...
*Defined in [Length/SI/Picometer.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Length/SI/Picometer.ts#L13)*
...
*Defined in [Length/SI/Picometer.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Length/SI/Picometer.ts#L14)*
