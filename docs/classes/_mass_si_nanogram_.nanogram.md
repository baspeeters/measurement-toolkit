[measurement-toolkit](../README.md) › ["Mass/SI/Nanogram"](../modules/_mass_si_nanogram_.md) › [Nanogram](_mass_si_nanogram_.nanogram.md)
...
* [constructor](_mass_si_nanogram_.nanogram.md#constructor)

### Properties

* [baseUnit](_mass_si_nanogram_.nanogram.md#baseunit)
* [symbol](_mass_si_nanogram_.nanogram.md#symbol)
* [value](_mass_si_nanogram_.nanogram.md#value)

### Accessors

* [to](_mass_si_nanogram_.nanogram.md#to)

### Methods

* [add](_mass_si_nanogram_.nanogram.md#add)
* [divideBy](_mass_si_nanogram_.nanogram.md#divideby)
* [dividedBy](_mass_si_nanogram_.nanogram.md#dividedby)
* [getConverters](_mass_si_nanogram_.nanogram.md#getconverters)
* [multiply](_mass_si_nanogram_.nanogram.md#multiply)
* [percentageOf](_mass_si_nanogram_.nanogram.md#percentageof)
* [percentageOfThis](_mass_si_nanogram_.nanogram.md#percentageofthis)
* [subtract](_mass_si_nanogram_.nanogram.md#subtract)
* [toString](_mass_si_nanogram_.nanogram.md#tostring)

## Constructors

###  constructor

\+ **new Nanogram**(`value`: number): *[Nanogram](_mass_si_nanogram_.nanogram.md)*
...
• **baseUnit**: *[Kilogram](_mass_si_kilogram_.kilogram.md)‹›* = new Kilogram(this.value * Math.pow(10, -12))
...
*Defined in [Mass/SI/Nanogram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/212ab3d/src/Units/Mass/SI/Nanogram.ts#L14)*
...
*Defined in [Mass/SI/Nanogram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/212ab3d/src/Units/Mass/SI/Nanogram.ts#L13)*
