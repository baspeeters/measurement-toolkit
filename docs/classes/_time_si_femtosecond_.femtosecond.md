[measurement-toolkit](../README.md) › ["Time/SI/Femtosecond"](../modules/_time_si_femtosecond_.md) › [Femtosecond](_time_si_femtosecond_.femtosecond.md)
...
* [constructor](_time_si_femtosecond_.femtosecond.md#constructor)

### Properties

* [baseUnit](_time_si_femtosecond_.femtosecond.md#baseunit)
* [symbol](_time_si_femtosecond_.femtosecond.md#symbol)
* [value](_time_si_femtosecond_.femtosecond.md#value)

### Accessors

* [to](_time_si_femtosecond_.femtosecond.md#to)

### Methods

* [add](_time_si_femtosecond_.femtosecond.md#add)
* [divideBy](_time_si_femtosecond_.femtosecond.md#divideby)
* [dividedBy](_time_si_femtosecond_.femtosecond.md#dividedby)
* [getConverters](_time_si_femtosecond_.femtosecond.md#getconverters)
* [multiply](_time_si_femtosecond_.femtosecond.md#multiply)
* [percentageOf](_time_si_femtosecond_.femtosecond.md#percentageof)
* [percentageOfThis](_time_si_femtosecond_.femtosecond.md#percentageofthis)
* [subtract](_time_si_femtosecond_.femtosecond.md#subtract)
* [toString](_time_si_femtosecond_.femtosecond.md#tostring)

## Constructors

###  constructor

\+ **new Femtosecond**(`value`: number): *[Femtosecond](_time_si_femtosecond_.femtosecond.md)*
...
• **baseUnit**: *[Second](_time_si_second_.second.md)‹›* = new Second(this.value * Math.pow(10, -15))
...
*Defined in [Time/SI/Femtosecond.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Time/SI/Femtosecond.ts#L14)*
...
*Defined in [Time/SI/Femtosecond.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Time/SI/Femtosecond.ts#L13)*
