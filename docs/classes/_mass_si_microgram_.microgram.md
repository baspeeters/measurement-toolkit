[measurement-toolkit](../README.md) › ["Mass/SI/Microgram"](../modules/_mass_si_microgram_.md) › [Microgram](_mass_si_microgram_.microgram.md)
...
* [constructor](_mass_si_microgram_.microgram.md#constructor)

### Properties

* [baseUnit](_mass_si_microgram_.microgram.md#baseunit)
* [symbol](_mass_si_microgram_.microgram.md#symbol)
* [value](_mass_si_microgram_.microgram.md#value)

### Accessors

* [to](_mass_si_microgram_.microgram.md#to)

### Methods

* [add](_mass_si_microgram_.microgram.md#add)
* [divideBy](_mass_si_microgram_.microgram.md#divideby)
* [dividedBy](_mass_si_microgram_.microgram.md#dividedby)
* [getConverters](_mass_si_microgram_.microgram.md#getconverters)
* [multiply](_mass_si_microgram_.microgram.md#multiply)
* [percentageOf](_mass_si_microgram_.microgram.md#percentageof)
* [percentageOfThis](_mass_si_microgram_.microgram.md#percentageofthis)
* [subtract](_mass_si_microgram_.microgram.md#subtract)
* [toString](_mass_si_microgram_.microgram.md#tostring)

## Constructors

###  constructor

\+ **new Microgram**(`value`: number): *[Microgram](_mass_si_microgram_.microgram.md)*
...
• **baseUnit**: *[Kilogram](_mass_si_kilogram_.kilogram.md)‹›* = new Kilogram(this.value * Math.pow(10, -9))
...
*Defined in [Mass/SI/Microgram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/SI/Microgram.ts#L14)*
...
*Defined in [Mass/SI/Microgram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/SI/Microgram.ts#L13)*
