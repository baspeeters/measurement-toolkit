[measurement-toolkit](../README.md) › ["Length/SI/Attometer"](../modules/_length_si_attometer_.md) › [Attometer](_length_si_attometer_.attometer.md)
...
* [constructor](_length_si_attometer_.attometer.md#constructor)

### Properties

* [baseUnit](_length_si_attometer_.attometer.md#baseunit)
* [symbol](_length_si_attometer_.attometer.md#symbol)
* [value](_length_si_attometer_.attometer.md#value)

### Accessors

* [to](_length_si_attometer_.attometer.md#to)

### Methods

* [add](_length_si_attometer_.attometer.md#add)
* [divideBy](_length_si_attometer_.attometer.md#divideby)
* [dividedBy](_length_si_attometer_.attometer.md#dividedby)
* [getConverters](_length_si_attometer_.attometer.md#getconverters)
* [multiply](_length_si_attometer_.attometer.md#multiply)
* [percentageOf](_length_si_attometer_.attometer.md#percentageof)
* [percentageOfThis](_length_si_attometer_.attometer.md#percentageofthis)
* [subtract](_length_si_attometer_.attometer.md#subtract)
* [toString](_length_si_attometer_.attometer.md#tostring)

## Constructors

###  constructor

\+ **new Attometer**(`value`: number): *[Attometer](_length_si_attometer_.attometer.md)*
...
• **baseUnit**: *[Meter](_length_si_meter_.meter.md)‹›* = new Meter(this.value * Math.pow(10, -18))
...
*Defined in [Length/SI/Attometer.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Length/SI/Attometer.ts#L13)*
...
*Defined in [Length/SI/Attometer.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Length/SI/Attometer.ts#L14)*
