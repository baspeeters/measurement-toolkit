[measurement-toolkit](../README.md) › ["Time/SI/Millisecond"](../modules/_time_si_millisecond_.md) › [Millisecond](_time_si_millisecond_.millisecond.md)
...
* [constructor](_time_si_millisecond_.millisecond.md#constructor)

### Properties

* [baseUnit](_time_si_millisecond_.millisecond.md#baseunit)
* [symbol](_time_si_millisecond_.millisecond.md#symbol)
* [value](_time_si_millisecond_.millisecond.md#value)

### Accessors

* [to](_time_si_millisecond_.millisecond.md#to)

### Methods

* [add](_time_si_millisecond_.millisecond.md#add)
* [divideBy](_time_si_millisecond_.millisecond.md#divideby)
* [dividedBy](_time_si_millisecond_.millisecond.md#dividedby)
* [getConverters](_time_si_millisecond_.millisecond.md#getconverters)
* [multiply](_time_si_millisecond_.millisecond.md#multiply)
* [percentageOf](_time_si_millisecond_.millisecond.md#percentageof)
* [percentageOfThis](_time_si_millisecond_.millisecond.md#percentageofthis)
* [subtract](_time_si_millisecond_.millisecond.md#subtract)
* [toString](_time_si_millisecond_.millisecond.md#tostring)

## Constructors

###  constructor

\+ **new Millisecond**(`value`: number): *[Millisecond](_time_si_millisecond_.millisecond.md)*
...
*Defined in [Time/SI/Millisecond.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Time/SI/Millisecond.ts#L14)*
...
*Defined in [Time/SI/Millisecond.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Time/SI/Millisecond.ts#L13)*
