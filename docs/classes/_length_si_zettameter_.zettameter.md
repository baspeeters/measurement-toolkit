[measurement-toolkit](../README.md) › ["Length/SI/Zettameter"](../modules/_length_si_zettameter_.md) › [Zettameter](_length_si_zettameter_.zettameter.md)
...
* [constructor](_length_si_zettameter_.zettameter.md#constructor)

### Properties

* [baseUnit](_length_si_zettameter_.zettameter.md#baseunit)
* [symbol](_length_si_zettameter_.zettameter.md#symbol)
* [value](_length_si_zettameter_.zettameter.md#value)

### Accessors

* [to](_length_si_zettameter_.zettameter.md#to)

### Methods

* [add](_length_si_zettameter_.zettameter.md#add)
* [divideBy](_length_si_zettameter_.zettameter.md#divideby)
* [dividedBy](_length_si_zettameter_.zettameter.md#dividedby)
* [getConverters](_length_si_zettameter_.zettameter.md#getconverters)
* [multiply](_length_si_zettameter_.zettameter.md#multiply)
* [percentageOf](_length_si_zettameter_.zettameter.md#percentageof)
* [percentageOfThis](_length_si_zettameter_.zettameter.md#percentageofthis)
* [subtract](_length_si_zettameter_.zettameter.md#subtract)
* [toString](_length_si_zettameter_.zettameter.md#tostring)

## Constructors

###  constructor

\+ **new Zettameter**(`value`: number): *[Zettameter](_length_si_zettameter_.zettameter.md)*
...
• **baseUnit**: *[Meter](_length_si_meter_.meter.md)‹›* = new Meter(this.value * Math.pow(10, 21))
...
*Defined in [Length/SI/Zettameter.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Length/SI/Zettameter.ts#L13)*
...
*Defined in [Length/SI/Zettameter.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Length/SI/Zettameter.ts#L14)*
