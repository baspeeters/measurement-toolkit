[measurement-toolkit](../README.md) › ["Mass/SI/Exagram"](../modules/_mass_si_exagram_.md) › [Exagram](_mass_si_exagram_.exagram.md)
...
* [constructor](_mass_si_exagram_.exagram.md#constructor)

### Properties

* [baseUnit](_mass_si_exagram_.exagram.md#baseunit)
* [symbol](_mass_si_exagram_.exagram.md#symbol)
* [value](_mass_si_exagram_.exagram.md#value)

### Accessors

* [to](_mass_si_exagram_.exagram.md#to)

### Methods

* [add](_mass_si_exagram_.exagram.md#add)
* [divideBy](_mass_si_exagram_.exagram.md#divideby)
* [dividedBy](_mass_si_exagram_.exagram.md#dividedby)
* [getConverters](_mass_si_exagram_.exagram.md#getconverters)
* [multiply](_mass_si_exagram_.exagram.md#multiply)
* [percentageOf](_mass_si_exagram_.exagram.md#percentageof)
* [percentageOfThis](_mass_si_exagram_.exagram.md#percentageofthis)
* [subtract](_mass_si_exagram_.exagram.md#subtract)
* [toString](_mass_si_exagram_.exagram.md#tostring)

## Constructors

###  constructor

\+ **new Exagram**(`value`: number): *[Exagram](_mass_si_exagram_.exagram.md)*
...
*Defined in [Mass/SI/Exagram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Mass/SI/Exagram.ts#L14)*
...
*Defined in [Mass/SI/Exagram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Mass/SI/Exagram.ts#L13)*
