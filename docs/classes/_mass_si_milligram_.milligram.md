[measurement-toolkit](../README.md) › ["Mass/SI/Milligram"](../modules/_mass_si_milligram_.md) › [Milligram](_mass_si_milligram_.milligram.md)
...
\+ **new Milligram**(`value`: number): *[Milligram](_mass_si_milligram_.milligram.md)*
...
*Defined in [Mass/SI/Milligram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/SI/Milligram.ts#L14)*
...
*Defined in [Mass/SI/Milligram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/SI/Milligram.ts#L13)*
