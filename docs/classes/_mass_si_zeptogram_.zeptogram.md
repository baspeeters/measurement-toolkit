[measurement-toolkit](../README.md) › ["Mass/SI/Zeptogram"](../modules/_mass_si_zeptogram_.md) › [Zeptogram](_mass_si_zeptogram_.zeptogram.md)
...
* [constructor](_mass_si_zeptogram_.zeptogram.md#constructor)

### Properties

* [baseUnit](_mass_si_zeptogram_.zeptogram.md#baseunit)
* [symbol](_mass_si_zeptogram_.zeptogram.md#symbol)
* [value](_mass_si_zeptogram_.zeptogram.md#value)

### Accessors

* [to](_mass_si_zeptogram_.zeptogram.md#to)

### Methods

* [add](_mass_si_zeptogram_.zeptogram.md#add)
* [divideBy](_mass_si_zeptogram_.zeptogram.md#divideby)
* [dividedBy](_mass_si_zeptogram_.zeptogram.md#dividedby)
* [getConverters](_mass_si_zeptogram_.zeptogram.md#getconverters)
* [multiply](_mass_si_zeptogram_.zeptogram.md#multiply)
* [percentageOf](_mass_si_zeptogram_.zeptogram.md#percentageof)
* [percentageOfThis](_mass_si_zeptogram_.zeptogram.md#percentageofthis)
* [subtract](_mass_si_zeptogram_.zeptogram.md#subtract)
* [toString](_mass_si_zeptogram_.zeptogram.md#tostring)

## Constructors

###  constructor

\+ **new Zeptogram**(`value`: number): *[Zeptogram](_mass_si_zeptogram_.zeptogram.md)*
...
• **baseUnit**: *[Kilogram](_mass_si_kilogram_.kilogram.md)‹›* = new Kilogram(this.value * Math.pow(10, -24))
...
*Defined in [Mass/SI/Zeptogram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Mass/SI/Zeptogram.ts#L14)*
...
*Defined in [Mass/SI/Zeptogram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b5deaf3/src/Units/Mass/SI/Zeptogram.ts#L13)*
