[measurement-toolkit](../README.md) › ["Mass/SI/Teragram"](../modules/_mass_si_teragram_.md) › [Teragram](_mass_si_teragram_.teragram.md)
...
* [constructor](_mass_si_teragram_.teragram.md#constructor)

### Properties

* [baseUnit](_mass_si_teragram_.teragram.md#baseunit)
* [symbol](_mass_si_teragram_.teragram.md#symbol)
* [value](_mass_si_teragram_.teragram.md#value)

### Accessors

* [to](_mass_si_teragram_.teragram.md#to)

### Methods

* [add](_mass_si_teragram_.teragram.md#add)
* [divideBy](_mass_si_teragram_.teragram.md#divideby)
* [dividedBy](_mass_si_teragram_.teragram.md#dividedby)
* [getConverters](_mass_si_teragram_.teragram.md#getconverters)
* [multiply](_mass_si_teragram_.teragram.md#multiply)
* [percentageOf](_mass_si_teragram_.teragram.md#percentageof)
* [percentageOfThis](_mass_si_teragram_.teragram.md#percentageofthis)
* [subtract](_mass_si_teragram_.teragram.md#subtract)
* [toString](_mass_si_teragram_.teragram.md#tostring)

## Constructors

###  constructor

\+ **new Teragram**(`value`: number): *[Teragram](_mass_si_teragram_.teragram.md)*
...
*Defined in [Mass/SI/Teragram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/SI/Teragram.ts#L14)*
...
*Defined in [Mass/SI/Teragram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/SI/Teragram.ts#L13)*
