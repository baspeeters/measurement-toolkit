[measurement-toolkit](../README.md) › ["Mass/US/Avoirdupois/Dram"](../modules/_mass_us_avoirdupois_dram_.md) › [Dram](_mass_us_avoirdupois_dram_.dram.md)
...
* [constructor](_mass_us_avoirdupois_dram_.dram.md#constructor)

### Properties

* [baseUnit](_mass_us_avoirdupois_dram_.dram.md#baseunit)
* [symbol](_mass_us_avoirdupois_dram_.dram.md#symbol)
* [value](_mass_us_avoirdupois_dram_.dram.md#value)

### Accessors

* [to](_mass_us_avoirdupois_dram_.dram.md#to)

### Methods

* [add](_mass_us_avoirdupois_dram_.dram.md#add)
* [divideBy](_mass_us_avoirdupois_dram_.dram.md#divideby)
* [dividedBy](_mass_us_avoirdupois_dram_.dram.md#dividedby)
* [getConverters](_mass_us_avoirdupois_dram_.dram.md#getconverters)
* [multiply](_mass_us_avoirdupois_dram_.dram.md#multiply)
* [percentageOf](_mass_us_avoirdupois_dram_.dram.md#percentageof)
* [percentageOfThis](_mass_us_avoirdupois_dram_.dram.md#percentageofthis)
* [subtract](_mass_us_avoirdupois_dram_.dram.md#subtract)
* [toString](_mass_us_avoirdupois_dram_.dram.md#tostring)

## Constructors

###  constructor

\+ **new Dram**(`value`: number): *[Dram](_mass_us_avoirdupois_dram_.dram.md)*
...
• **baseUnit**: *[Pound](_mass_us_avoirdupois_pound_.pound.md)‹›* = new Pound(this.value / 256)
...
*Defined in [Mass/US/Avoirdupois/Dram.ts:14](https://github.com/baspeeters/measurement-toolkit/blob/212ab3d/src/Units/Mass/US/Avoirdupois/Dram.ts#L14)*
...
*Defined in [Mass/US/Avoirdupois/Dram.ts:13](https://github.com/baspeeters/measurement-toolkit/blob/212ab3d/src/Units/Mass/US/Avoirdupois/Dram.ts#L13)*
