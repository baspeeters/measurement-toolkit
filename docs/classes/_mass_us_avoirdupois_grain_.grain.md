[measurement-toolkit](../README.md) › ["Mass/US/Avoirdupois/Grain"](../modules/_mass_us_avoirdupois_grain_.md) › [Grain](_mass_us_avoirdupois_grain_.grain.md)
...
* [constructor](_mass_us_avoirdupois_grain_.grain.md#constructor)

### Properties

* [baseUnit](_mass_us_avoirdupois_grain_.grain.md#baseunit)
* [symbol](_mass_us_avoirdupois_grain_.grain.md#symbol)
* [value](_mass_us_avoirdupois_grain_.grain.md#value)

### Accessors

* [to](_mass_us_avoirdupois_grain_.grain.md#to)

### Methods

* [add](_mass_us_avoirdupois_grain_.grain.md#add)
* [divideBy](_mass_us_avoirdupois_grain_.grain.md#divideby)
* [dividedBy](_mass_us_avoirdupois_grain_.grain.md#dividedby)
* [getConverters](_mass_us_avoirdupois_grain_.grain.md#getconverters)
* [multiply](_mass_us_avoirdupois_grain_.grain.md#multiply)
* [percentageOf](_mass_us_avoirdupois_grain_.grain.md#percentageof)
* [percentageOfThis](_mass_us_avoirdupois_grain_.grain.md#percentageofthis)
* [subtract](_mass_us_avoirdupois_grain_.grain.md#subtract)
* [toString](_mass_us_avoirdupois_grain_.grain.md#tostring)

### Object literals

* [derivedUnits](_mass_us_avoirdupois_grain_.grain.md#derivedunits)

## Constructors

###  constructor

\+ **new Grain**(`value`: number): *[Grain](_mass_us_avoirdupois_grain_.grain.md)*
...
• **baseUnit**: *[Pound](_mass_us_avoirdupois_pound_.pound.md)‹›* = new Pound(this.value / 7000)
...
*Defined in [Mass/US/Avoirdupois/Grain.ts:17](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/US/Avoirdupois/Grain.ts#L17)*
...
*Defined in [Mass/US/Avoirdupois/Grain.ts:16](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/US/Avoirdupois/Grain.ts#L16)*
...
*Defined in [Mass/US/Avoirdupois/Grain.ts:18](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/US/Avoirdupois/Grain.ts#L18)*

###  TroyPound

▸ **TroyPound**(): *[TroyPound](_mass_us_troy_troypound_.troypound.md)*

*Defined in [Mass/US/Avoirdupois/Grain.ts:19](https://github.com/baspeeters/measurement-toolkit/blob/b77bfc1/src/Units/Mass/US/Avoirdupois/Grain.ts#L19)*
